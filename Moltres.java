...
public class Moltres extends Pokemon implements FireType{
    public Moltres() {
        super("Moltres", "FireType", 4, FireType.ATTACK_NAME, FireType.ATTACK_DMG, FireType.SPECIAL_ATTACKS, FireType.SPECIAL_ATTACK_DMG);
