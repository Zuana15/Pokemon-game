...
public class Chikorita extends Pokemon implements GrassType{
	
	public Chikorita() {
		super("Chikorita", "GrassType", 4, GrassType.ATTACK_NAME, GrassType.ATTACK_DMG, GrassType.SPECIAL_ATTACKS, GrassType.SPECIAL_ATTACK_DMG);
