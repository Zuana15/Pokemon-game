...
public class Growlith extends Pokemon implements FireType{
    public Growlith() {
        super("Growlith", "FireType", 5, FireType.ATTACK_NAME, FireType.ATTACK_DMG, FireType.SPECIAL_ATTACKS, FireType.SPECIAL_ATTACK_DMG);
