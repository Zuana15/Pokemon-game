...
public class Mudkip extends Pokemon implements WaterType{
    public Mudkip() {
        super("Mudkip", "WaterType", 5, WaterType.ATTACK_NAME, WaterType.ATTACK_DMG, WaterType.SPECIAL_ATTACKS, WaterType.SPECIAL_ATTACK_DMG);
