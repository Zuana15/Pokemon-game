...
public class Sceptile extends Pokemon implements GrassType{
	
	public Sceptile() {
		super("Sceptile", "GrassType", 2, GrassType.ATTACK_NAME, GrassType.ATTACK_DMG, GrassType.SPECIAL_ATTACKS, GrassType.SPECIAL_ATTACK_DMG);
