...
public class Torterra extends Pokemon implements GrassType {
	
	public Torterra() {
		super("Torterra", "GrassType", 3, GrassType.ATTACK_NAME, GrassType.ATTACK_DMG, GrassType.SPECIAL_ATTACKS, GrassType.SPECIAL_ATTACK_DMG);
